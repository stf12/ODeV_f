 ...
 */
inline sys_error_code_t IapmhInit(IAppPowerModeHelper *this);
 ...
 */
inline EPowerMode IapmhComputeNewPowerMode(IAppPowerModeHelper *this, const SysEvent xEvent);
 ...
 */
inline boolean_t IapmhCheckPowerModeTransaction(IAppPowerModeHelper *this, const EPowerMode eActivePowerMode, const EPowerMode eNewPowerMode);
 ...
 */
inline sys_error_code_t IapmhDidEnterPowerMode(IAppPowerModeHelper *this, EPowerMode ePowerMode);
 ...
 */
inline EPowerMode IapmhGetActivePowerMode(IAppPowerModeHelper *this);
 ...
 */
inline SysPowerStatus IapmhGetPowerStatus(IAppPowerModeHelper *this);
 ...
 */
inline boolean_t IapmhIsLowPowerMode(IAppPowerModeHelper *this, const EPowerMode ePowerMode);
