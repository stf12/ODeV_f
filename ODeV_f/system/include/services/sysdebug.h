...
#define SYS_DBG_LEVEL_ALL      0x00 ///< All debug message are sent to the debug channel.
#define SYS_DBG_LEVEL_VERBOSE  0x01 ///< A general message for system developers.
#define SYS_DBG_LEVEL_LLA      0x02 ///< A message for system developers generated by a Low Level API function.
#define SYS_DBG_LEVEL_SL       0x03 ///< A message for system developers generated by a Service Layer function.
#define SYS_DBG_LEVEL_DEFAULT  0x04 ///< A message generated by application code.
#define SYS_DBG_LEVEL_WARNING  0x05 ///< A message generated when a minor error occurs. The system is probably able to auto-recovers.
#define SYS_DBG_LEVEL_SEVERE   0x06 ///< A message generated when a critical error occurs. The system probably hangs.
#define SYS_DBG_MASK_LEVEL     0x07
