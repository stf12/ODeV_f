 ...
 *
 *****************************************************************************/
#ifndef STM32HAL_DPI_HPP
#define STM32HAL_DPI_HPP

#include <touchgfx/hal/HAL.hpp>
#include <platform/driver/touch/TouchController.hpp>

/**
 * @class STM32HAL_DPI STM32HAL_DPI.hpp platform/hal/ST/mcu/stm32f4x9/STM32HAL_DPI.hpp
 *
 ...
 * @sa HAL
 */
class STM32HAL_DPI : public touchgfx::HAL
{
public:
    /**
     * @fn STM32HAL_DPI::STM32HAL_DPI(touchgfx::DMA_Interface& dma, touchgfx::LCD& display, touchgfx::TouchController& tc, uint16_t width, uint16_t height) : touchgfx::HAL(dma, display, tc, width, height)
     *
     * @brief Constructor.
     *
     ...
     */
    STM32HAL_DPI(touchgfx::DMA_Interface& dma, touchgfx::LCD& display, touchgfx::TouchController& tc, uint16_t width, uint16_t height) : touchgfx::HAL(dma, display, tc, width, height)
    {
    }
    /**
     * @fn virtual void STM32HAL_DPI::disableInterrupts();
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::enableInterrupts();
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::configureInterrupts();
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::enableLCDControllerInterrupt();
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::flushFrameBuffer();
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::flushFrameBuffer(const Rect& rect);
     *
...
protected:
    /**
     * @fn virtual uint16_t* STM32HAL_DPI::getTFTFrameBuffer() const;
     *
    ...
    /**
     * @fn virtual void STM32HAL_DPI::setTFTFrameBuffer(uint16_t* adr);
     *
