...
/**
 * @class STM32DMA STM32DMA.hpp
 *
 * @brief This class specializes DMA_Interface for the STM32 L4xx processors.
 *
 *        This class specializes DMA_Interface for the STM32 L4xx processors.
 *
...
public:
    ...
    /**
     * @fn void STM32DMA::setDeadTime(uint8_t dt)
     *
