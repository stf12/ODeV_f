...
namespace touchgfx
{
void STM32MCUInstrumentation::init()
{
...
unsigned int STM32MCUInstrumentation::getElapsedUS(unsigned int start, unsigned int now, unsigned int clockfrequency)
{
    return ((now - start) + (clockfrequency / 2)) / clockfrequency;
}

unsigned int STM32MCUInstrumentation::getCPUCycles()
{
    return *((volatile unsigned int*)0xE0001004);
}

void STM32MCUInstrumentation::setMCUActive(bool active)
{
